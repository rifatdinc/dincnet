...
export const ParcelAccordionItems = ({
  ...
  return (
    ...
    >
      <div
        className="grid cursor-pointer grid-cols-2 p-4 transition-all duration-300 hover:bg-component-secondary/40 sm:grid-cols-4"
        onClick={openHandler}
      >
        ...
        <p className="label-md col-span-1 px-2 text-center">
          Shipping:{' '}
          <span
