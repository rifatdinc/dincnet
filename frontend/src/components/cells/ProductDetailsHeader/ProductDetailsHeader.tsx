...
export const ProductDetailsHeader = ({
  ...
  const selectedOrFallbackVariant =
    product.variants?.find(({ id }) => id === variantId) || fallbackVariant

  const variantStock = selectedOrFallbackVariant?.inventory_quantity || 0

  const variantHasPrice = !!selectedOrFallbackVariant?.calculated_price
    ...
    <div className="border rounded-sm p-5" data-testid="product-details-header">
      <div className="flex justify-between">
        <div>
          ...
          <p className="label-sm text-secondary" data-testid="product-stock-status">
