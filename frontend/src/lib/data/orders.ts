...
export const retrieveOrder = async (id: string) => {
  ...
  return sdk.client
    .fetch<HttpTypes.StoreOrderResponse>(`/store/orders/${id}`, {
      ...
      query: {
        fields:
          '*payment_collections.payments,*items,*items.metadata,*items.variant,*items.product,shipping_total,total,created_at,currency_code,display_id,fulfillment_status,email'
      },
      headers,
      next,
      cache: 'force-cache'
  ...
  return sdk.client
    .fetch<{
      ...
      query: {
        ...
        order: '-created_at',
        fields:
          '*items,+items.metadata,*items.variant,*items.product,shipping_total,total,created_at,currency_code,display_id,fulfillment_status',
        ...filters
      },
      headers,
      next,
