...
async function AllCategories({
  ...
  return (
    <main className="container">
      ...
      <Suspense
        key={`all-categories-${currentPage}`}
        fallback={<div data-testid="all-categories-page-loading"><ProductListingSkeleton /></div>}
      >
        <ProductListing showSidebar locale={locale} page={currentPage} />
      </Suspense>
    </main>
  )
}
