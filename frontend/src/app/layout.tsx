...
export const metadata: Metadata = {
  title: {
    template: `%s | ${
      process.env.NEXT_PUBLIC_SITE_NAME || 'DincNet - Marketplace Storefront'
    }`,
    default: process.env.NEXT_PUBLIC_SITE_NAME || 'DincNet - Marketplace Storefront'
  },
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'DincNet - Marketplace Storefront',
...
export default async function RootLayout({
  ...
  const shouldRetrieveCart = acceptHeader.includes('text/html');
  const cart = shouldRetrieveCart ? await retrieveCart() : null;
